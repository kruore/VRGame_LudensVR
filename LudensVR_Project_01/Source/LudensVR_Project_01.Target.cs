...
public class LudensVR_Project_01Target : TargetRules
{
	public LudensVR_Project_01Target(TargetInfo Target) : base(Target)
	{
		Type = TargetType.Game;

		ExtraModuleNames.AddRange( new string[] { "LudensVR_Project_01" } );
	}
}
