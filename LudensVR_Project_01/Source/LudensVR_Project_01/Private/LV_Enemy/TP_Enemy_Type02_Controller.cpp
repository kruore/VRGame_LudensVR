...
const FName ATP_Enemy_Type02_Controller::HomePosKey(TEXT("HomePos"));
const FName ATP_Enemy_Type02_Controller::PatrolPosKey(TEXT("PatrolPos"));
const FName ATP_Enemy_Type02_Controller::PlayerPosKey(TEXT("PlayerPos"));

ATP_Enemy_Type02_Controller::ATP_Enemy_Type02_Controller()
{
...
void ATP_Enemy_Type02_Controller::Possess(APawn *InPawn)
{
