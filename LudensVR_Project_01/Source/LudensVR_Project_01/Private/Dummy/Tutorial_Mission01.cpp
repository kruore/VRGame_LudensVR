...
// Sets default values
ATutorial_Mission01::ATutorial_Mission01()
{
	...
	_text->SetText("Welcome! agent N-012!\nThis is AvangerVR Tutorial.\nNow, You will Learn How to Move\n\nControl your left joy stick to move.");
...
void ATutorial_Mission01::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ATutorial_Mission01::Tick(float DeltaTime)
{
