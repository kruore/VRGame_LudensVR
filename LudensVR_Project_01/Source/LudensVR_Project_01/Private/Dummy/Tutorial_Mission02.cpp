...
// Sets default values
ATutorial_Mission02::ATutorial_Mission02()
{
	...
	_text->AddRelativeLocation(FVector(23.0f, 46.0f, 1.0f));
...
void ATutorial_Mission02::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ATutorial_Mission02::Tick(float DeltaTime)
{
