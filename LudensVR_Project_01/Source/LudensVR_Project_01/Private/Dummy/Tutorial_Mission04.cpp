...
// Sets default values
ATutorial_Mission04::ATutorial_Mission04()
{
	...
	Mesh->SetCollisionProfileName(TEXT("TutorialLevel04"));
	Tags.Add(FName("Tutorial Leve04"));

	_text = CreateDefaultSubobject<UTextRenderComponent>("TextComponent");
	_text->SetTextRenderColor(FColor::White);
	_text->SetText("You can test\nyour weapons in this room.");
...
void ATutorial_Mission04::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ATutorial_Mission04::Tick(float DeltaTime)
{
