...
#include "LV_GuideHighLightActor.generated.h"

UCLASS()
class LUDENSVR_PROJECT_01_API ALV_GuideHighLightActor : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ALV_GuideHighLightActor();
...
public:
	...
	class UParticleSystemComponent * Highlight_Particle02;
