...
#include "TP_Enemy_Type02_AniInstance.generated.h"

/**
 *
 */
UCLASS()
class LUDENSVR_PROJECT_01_API UTP_Enemy_Type02_AniInstance : public UAnimInstance
{
	GENERATED_BODY()

public:
	UTP_Enemy_Type02_AniInstance();
