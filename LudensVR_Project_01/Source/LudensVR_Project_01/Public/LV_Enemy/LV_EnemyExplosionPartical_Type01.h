...
#include "LV_EnemyExplosionPartical_Type01.generated.h"

UCLASS()
class LUDENSVR_PROJECT_01_API ALV_EnemyExplosionPartical_Type01 : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ALV_EnemyExplosionPartical_Type01();
