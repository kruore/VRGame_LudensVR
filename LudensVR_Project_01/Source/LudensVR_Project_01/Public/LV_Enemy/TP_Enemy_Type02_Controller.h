...
#include "TP_Enemy_Type02_Controller.generated.h"

/**
 *
 */
UCLASS()
class LUDENSVR_PROJECT_01_API ATP_Enemy_Type02_Controller : public AAIController
{
	GENERATED_BODY()


public:
	ATP_Enemy_Type02_Controller();
