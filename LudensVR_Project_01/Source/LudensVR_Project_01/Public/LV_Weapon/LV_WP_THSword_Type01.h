...
#include "LV_WP_THSword_Type01.generated.h"

UCLASS()
class LUDENSVR_PROJECT_01_API ALV_WP_THSword_Type01 : public AActor, public LV_WP_SwordClass, public ITP_InteractionInterface
{
	GENERATED_BODY()

public:
	// Sets default values for this actor's properties
	ALV_WP_THSword_Type01();
